...
import com.zetaco.fake.frameworks.BJobManager;
import com.zetaco.fake.frameworks.BPackageManager;
import com.zetaco.fake.frameworks.BStorageManager;
import com.zetaco.fake.frameworks.BUserManager;
import com.zetaco.fake.frameworks.BXposedManager;
import com.zetaco.fake.hook.HookManager;
import com.zetaco.proxy.ProxyManifest;
import com.zetaco.utils.FileUtils;
import com.zetaco.utils.ShellUtils;
import com.zetaco.utils.Slog;
import com.zetaco.utils.compat.BuildCompat;
import com.zetaco.utils.compat.BundleCompat;
import com.zetaco.utils.compat.XposedParserCompat;
import com.zetaco.utils.provider.ProviderCall;

@SuppressLint({"StaticFieldLeak", "NewApi"})
public class ZetaBCore extends ClientConfiguration {
    public static final String TAG = "ZetaBCore";

    private static final ZetaBCore sZetaBoxCore = new ZetaBCore();
    ...
    public void doAttachBaseContext(Context context, ClientConfiguration clientConfiguration) {
        ...
        if (processName.equals(ZetaBCore.getHostPkg())) {
            mProcessType = ProcessType.Main;
            startLogcat();
        } else if (processName.endsWith(getContext().getString(R.string.zetab_service_name))) {
    ...
    private void initNotificationManager() {
        NotificationManager nm = (NotificationManager) ZetaBCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        String CHANNEL_ONE_ID = ZetaBCore.getContext().getPackageName() + ".zetab_core";
        String CHANNEL_ONE_NAME = "zetab_core";
