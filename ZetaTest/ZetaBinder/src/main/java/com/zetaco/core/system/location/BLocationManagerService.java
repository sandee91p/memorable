package com.zetaco.core.system.location;
...
import org.android.location.ILocationListener;
...
import com.zetaco.entity.location.BLocationConfig;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                ZetaBCore.get().getHandler().post(() -> ILocationListener.onLocationChanged.call(iInterface, location.convert2SystemLocation()));
            }
        });
    }
