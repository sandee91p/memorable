package com.zetaco.core.system.notification;
...
import org.android.app.NotificationO;
...
public class BNotificationManagerService extends IBNotificationManagerService.Stub implements ISystemService {
    ...
    private final NotificationManager mRealNotificationManager = (NotificationManager) ZetaBCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private void handleNotificationChannel(NotificationChannel notificationChannel, int userId) {
        String channelId = org.android.app.NotificationChannel.mId.get(notificationChannel);
        String blackChannelId = getBlackChannelId(channelId, userId);

        org.android.app.NotificationChannel.mId.set(notificationChannel, blackChannelId);
    ...
    private void resetNotificationChannel(NotificationChannel notificationChannel) {
        ...
        org.android.app.NotificationChannel.mId.set(notificationChannel, realChannelId);
    }

    private void handleNotificationGroup(NotificationChannelGroup notificationChannelGroup, int userId) {
        String groupId = org.android.app.NotificationChannelGroup.mId.get(notificationChannelGroup);
        String blackGroupId = getBlackGroupId(groupId, userId);
        org.android.app.NotificationChannelGroup.mId.set(notificationChannelGroup, blackGroupId);

        List<NotificationChannel> notificationChannels = org.android.app.NotificationChannelGroup.mChannels.get(notificationChannelGroup);
    ...
    private void resetNotificationGroup(NotificationChannelGroup notificationChannelGroup) {
        ...
        org.android.app.NotificationChannelGroup.mId.set(notificationChannelGroup, realGroupId);
