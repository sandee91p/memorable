...
import com.zetaco.utils.TrieTree;
...
public class IOCore {
    ...
    public void enableRedirect(Context context) {
        ...
        try {
            ...
            int systemUserId = ZetaBCore.getHostUserId();
            List<ApplicationInfo> installedApplications = ZetaBCore.getBPackageManager().getInstalledApplications(PackageManager.GET_META_DATA, BActivityThread.getUserId());
            ...
            if (ZetaBCore.getContext().getExternalCacheDir() != null && context.getExternalCacheDir() != null) {
