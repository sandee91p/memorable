...
public class BEnvironment {
    private static final File sVirtualRoot = new File(ZetaBCore.getContext().getCacheDir().getParent(), "zeta");
    private static final File sExternalVirtualRoot = ZetaBCore.getContext().getExternalFilesDir("zeta");
