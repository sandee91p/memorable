...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = ZetaBCore.getHostPkg().hashCode();
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".zetab_core")
