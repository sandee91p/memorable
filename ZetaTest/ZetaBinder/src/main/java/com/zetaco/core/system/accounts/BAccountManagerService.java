package com.zetaco.core.system.accounts;
...
import com.zetaco.utils.compat.AccountManagerCompat;
...
public class BAccountManagerService extends IBAccountManagerService.Stub implements ISystemService, PackageMonitor {
    ...
    public BAccountManagerService() {
        this.mContext = ZetaBCore.getContext();
    ...
    private static AuthenticatorDescription parseAuthenticatorDescription(Resources resources, String packageName, AttributeSet attributeSet) {
        TypedArray array = resources.obtainAttributes(attributeSet, ArrayUtils.toInt(org.com.android.internal.R.styleable.AccountAuthenticator.get()));
        try {
            String accountType = array.getString(org.com.android.internal.R.styleable.AccountAuthenticator_accountType.get());
            int label = array.getResourceId(org.com.android.internal.R.styleable.AccountAuthenticator_label.get(), 0);
            int icon = array.getResourceId(org.com.android.internal.R.styleable.AccountAuthenticator_icon.get(), 0);
            int smallIcon = array.getResourceId(org.com.android.internal.R.styleable.AccountAuthenticator_smallIcon.get(), 0);
            int accountPreferences = array.getResourceId(org.com.android.internal.R.styleable.AccountAuthenticator_accountPreferences.get(), 0);
            boolean customTokens = array.getBoolean(org.com.android.internal.R.styleable.AccountAuthenticator_customTokens.get(), false);
