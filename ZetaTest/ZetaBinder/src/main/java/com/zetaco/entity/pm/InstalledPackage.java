...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return ZetaBCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return ZetaBCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
