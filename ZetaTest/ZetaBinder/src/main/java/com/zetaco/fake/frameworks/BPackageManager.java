...
import com.zetaco.core.system.pm.IBPackageManagerService;
...
public class BPackageManager extends BlackManager<IBPackageManagerService> {
    ...
    public Intent getLaunchIntentForPackage(String packageName, int userId) {
        ...
        List<ResolveInfo> ris = queryIntentActivities(intentToResolve, 0,
                intentToResolve.resolveTypeIfNeeded(ZetaBCore.getContext().getContentResolver()), userId);
        ...
        if (ris == null || ris.size() <= 0) {
            ...
            intentToResolve.setPackage(packageName);
            ris = queryIntentActivities(intentToResolve, 0, intentToResolve.resolveTypeIfNeeded(ZetaBCore.getContext().getContentResolver()), userId);
        }
