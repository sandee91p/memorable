...
import org.android.location.ILocationManager;
import org.android.location.provider.ProviderProperties;
import org.android.os.ServiceManager;
import com.zetaco.app.BActivityThread;
import com.zetaco.entity.location.BLocation;
...
import com.zetaco.fake.service.context.LocationListenerProxy;
    ...
    public static class RegisterGnssStatusCallback extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (BLocationManager.isFakeLocationEnable()) {
                Object transport = MethodParameterUtils.getFirstParam(args, org.android.location.LocationManager.GnssStatusListenerTransport.REF.getClazz());

                if (transport != null) {
                    org.android.location.LocationManager.GnssStatusListenerTransport.onGnssStarted.call(transport);
                    ...
                    if (location != null) {
                        try {
                            ...
                            org.android.location.LocationManager.GnssStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), "$GPGSV,1,1,04,12,05,159,36,15,41,087,15,19,38,262,30,31,56,146,19,*73");
                            if (BuildCompat.isN()) {
                                org.android.location.LocationManager.GpsStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), "$GPGSV,1,1,04,12,05,159,36,15,41,087,15,19,38,262,30,31,56,146,19,*73");
                                org.android.location.LocationManager.GpsStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), $GPGGA);
                                org.android.location.LocationManager.GpsStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), "$GPVTG,0,T,0,M,0,N,0,K,A,*25");
                                org.android.location.LocationManager.GpsStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), $GPRMC);
                                org.android.location.LocationManager.GpsStatusListenerTransport.onNmeaReceived.call(transport, System.currentTimeMillis(), "$GPGSA,A,2,12,15,19,31,,,,,,,,,604,712,986,*27");
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    public static class RegisterLocationListener extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (BLocationManager.isFakeLocationEnable()) {
                ...
                if (listener != null) {
                    try {
                        org.android.location.LocationManager.LocationListenerTransport.mListener.set(listener,
                                new LocationListenerProxy().wrapper(org.android.location.LocationManager.LocationListenerTransport.mListener.get()));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
