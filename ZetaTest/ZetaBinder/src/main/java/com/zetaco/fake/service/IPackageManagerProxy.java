...
public class IPackageManagerProxy extends BinderInvocationStub {
            ...
            addMethodHook("getPackageInfoVersioned", new MethodHook() {
                ...
                protected Object hook(Object who, Method method, Object[] args) throws Throwable {
                    ...
                    if (BuildCompat.isT()) {
                        ...
                        packageInfo = ZetaBCore.getBPackageManager().getPackageInfo(packageName, Math.toIntExact(flags), BActivityThread.getUserId());
                    } else {
                        int flags = (int) args[1];
                        packageInfo = ZetaBCore.getBPackageManager().getPackageInfo(packageName, flags, BActivityThread.getUserId());
                    }
    ...
    public static class ResolveIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                ...
                resolveInfo = ZetaBCore.getBPackageManager().resolveIntent(intent, resolvedType, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[2];
                resolveInfo = ZetaBCore.getBPackageManager().resolveIntent(intent, resolvedType, flags, BActivityThread.getUserId());
            }
    ...
    public static class ResolveService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[2];
                resolveInfo = ZetaBCore.getBPackageManager().resolveService(intent, Math.toIntExact(flags), resolvedType, BActivityThread.getUserId());
            } else {
                int flags = (int) args[2];
                resolveInfo = ZetaBCore.getBPackageManager().resolveService(intent, flags, resolvedType, BActivityThread.getUserId());
            }
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                providerInfo = ZetaBCore.getBPackageManager().getProviderInfo(componentName, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                providerInfo = ZetaBCore.getBPackageManager().getProviderInfo(componentName, flags, BActivityThread.getUserId());
            }
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                receiverInfo = ZetaBCore.getBPackageManager().getReceiverInfo(componentName, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                receiverInfo = ZetaBCore.getBPackageManager().getReceiverInfo(componentName, flags, BActivityThread.getUserId());
            }
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                activityInfo = ZetaBCore.getBPackageManager().getActivityInfo(componentName, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                activityInfo = ZetaBCore.getBPackageManager().getActivityInfo(componentName, Math.toIntExact(flags), BActivityThread.getUserId());
            }
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                serviceInfo = ZetaBCore.getBPackageManager().getServiceInfo(componentName, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                serviceInfo = ZetaBCore.getBPackageManager().getServiceInfo(componentName, flags, BActivityThread.getUserId());
            }
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                ...
                installedApplications = ZetaBCore.getBPackageManager().getInstalledApplications(Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[0];
                installedApplications = ZetaBCore.getBPackageManager().getInstalledApplications(flags, BActivityThread.getUserId());
            }
    ...
    public static class QueryIntentActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[2];
                intentActivities = ZetaBCore.getBPackageManager().queryIntentActivities(intent, Math.toIntExact(flags), resolvedType, BActivityThread.getUserId());
            } else {
                int flags = (int) args[2];
                intentActivities = ZetaBCore.getBPackageManager().queryIntentActivities(intent, flags, resolvedType, BActivityThread.getUserId());
            }
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[0];
                installedPackages = ZetaBCore.getBPackageManager().getInstalledPackages(Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[0];
                installedPackages = ZetaBCore.getBPackageManager().getInstalledPackages(flags, BActivityThread.getUserId());
            }
    ...
    public static class GetApplicationInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                applicationInfo = ZetaBCore.getBPackageManager().getApplicationInfo(packageName, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                applicationInfo = ZetaBCore.getBPackageManager().getApplicationInfo(packageName, flags, BActivityThread.getUserId());
            }
    ...
    public static class QueryContentProviders extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                ...
                providers = ZetaBCore.getBPackageManager()
    ...
    public static class QueryBroadcastReceivers extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                ...
                resolves = ZetaBCore.getBPackageManager().queryBroadcastReceivers(intent, Math.toIntExact(flags), type, BActivityThread.getUserId());
            } else {
                Integer flags = MethodParameterUtils.getFirstParam(args, Integer.class);
                resolves = ZetaBCore.getBPackageManager().queryBroadcastReceivers(intent, flags, type, BActivityThread.getUserId());
            }
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BuildCompat.isT()) {
                long flags = (long) args[1];
                providerInfo = ZetaBCore.getBPackageManager().resolveContentProvider(authority, Math.toIntExact(flags), BActivityThread.getUserId());
            } else {
                int flags = (int) args[1];
                providerInfo = ZetaBCore.getBPackageManager().resolveContentProvider(authority, flags, BActivityThread.getUserId());
            }
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == ZetaBCore.getHostUid()) {
                args[0] = BActivityThread.getBUid();
                uid = (int) args[0];
            }

            String[] packagesForUid = ZetaBCore.getBPackageManager().getPackagesForUid(uid);
