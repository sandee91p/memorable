...
public class ActivityCompat {
    public static void fix(Activity activity) {
        ...
        try {
            TypedArray typedArray = activity.obtainStyledAttributes(ArrayUtils.toInt(org.com.android.internal.R.styleable.Window.get()));
            if (typedArray != null) {
                boolean isShowWallpaper = typedArray.getBoolean(org.com.android.internal.R.styleable.Window_windowShowWallpaper.get(), false);
                if (isShowWallpaper) {
                    activity.getWindow().setBackgroundDrawable(WallpaperManager.getInstance(activity).getDrawable());
                }

                boolean isFullscreen = typedArray.getBoolean(org.com.android.internal.R.styleable.Window_windowFullscreen.get(), false);
                if (isFullscreen) {
